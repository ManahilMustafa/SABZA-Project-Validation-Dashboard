...
import PendingValidationPage from "../pendingproj";
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-700">
                  <strong>Blockchain Security:</strong> This project is secured
              ...
              <div className="flex items-center gap-2">
                <span>🔍</span>
                <span className="text-gray-700">
                  <strong>SABZA Validation:</strong> Independent third-party
              ...
              <div className="flex items-center gap-2">
                <span>💎</span>
                <span className="text-gray-700">
                  <strong>Bitbond Integration:</strong> Awaiting validation
                  completion
                </span>
              </div>
            </div>
